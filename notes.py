# requiremnets.txt file to include pip installed libraries
#
# project.py file - must include main and 3 other functions
#
# test_project.py file
#
#
# README.md  explanation of about 500 words
#
#
# youtube video
...
# Gather user data such as user name: workout routine name; date; exercise; reps; weight; sets workout to enter workout info and user name -

# Back; Pull-ups; reps; weight; set


#
# Object: Workout routine ei Back
# """collection of excercises"""
#
#
# Object: Exercise
# """one or more of the same exercise"""
#
#
...
# 1 Enter new workout
# 2 Display workout to screen
# 3 Save workout to file
# 4 Exit
